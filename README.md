...
> Use **[gnolang/getting-started](https://github.com/gnolang/getting-started)** instead —
> a working realm, tests, and `gnodev` hot-reload in about five minutes.
> For a fuller project scaffold, see
> [gnolang/repo-template](https://github.com/gnolang/repo-template).
>
> The content below is kept for reference and describes a pre-mainnet world.
...
1. Check out the tutorial section of [Awesome Gno](https://github.com/gnoverse/awesome-gno#tutorials-presentations-resources) and explore the [YouTube channel](https://www.youtube.com/@_gnoland/videos) for previous workshops and demos.
...
- Community Content: https://github.com/gnoverse/awesome-gno
